...
class Game():
    ...
    def answer_chek(answer):
        x = False
        if answer == 'y':
            if player_card[0].count(*out_bag) == 1 or player_card[1].count(*out_bag) == 1 or player_card[2].count(*out_bag) == 1:
                x = True
                return x
            elif player_card[0].count(*out_bag) == 0 or player_card[1].count(*out_bag) == 0 or player_card[2].count(*out_bag) == 0:
                return x
